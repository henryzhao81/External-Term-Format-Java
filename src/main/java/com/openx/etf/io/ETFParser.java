...
import com.openx.etf.ETFConfig;
import com.openx.etf.erlang.DistributionHeader;
import com.openx.etf.erlang.ErlangList;
import com.openx.etf.erlang.ErlangMap;
import com.openx.etf.erlang.Fun;
import com.openx.etf.erlang.PID;
import com.openx.etf.erlang.Port;
import com.openx.etf.erlang.Reference;
import com.openx.etf.erlang.Tuple;
import com.openx.etf.util.ETFException;

import static com.openx.etf.TermTypes.*;
...
public class ETFParser {
  ...
  public byte peek() {
      checkPreconditions();
      byte pb = data[offset];
      System.out.println("DEBUG: peek offset : " + offset + " data = " + pb);
      return pb;
  }
  ...
  public String nextBinary() {
      ...
      offset += 4;
      System.out.println("DEBUG: nextBinary len : " + len + " current offset : " + offset);
      String str = new String(Arrays.copyOfRange(data, offset, (offset += len)));
      System.out.println("DEBUG: nextBinary result : " + str + " current offset : " + offset);
      return str;
  }
  ...
  private Tuple findTuple(long arity) {
    System.out.println("DEBUG: findTupe arity : " + arity);
  ...
  public Tuple nextSmallTuple() {
      ...
      System.out.println("DEBUG: nextSmallTuple offset : " + offset);
   ...
   */
  public void nextNil() {
    System.out.println("DEBUG: nextNil offset : " + offset);
      if (peek() == NIL_EXT || !loqui)
  ...
  private long nextBig(long len) {
      ...
      System.out.println("DEBUG: nextBig offset : " + offset + " len : " + len + " sign : " + sign);
      long total = 0L;
  ...
  public long nextSmallBig() {
      ...
      System.out.println("DEBUG: nextSmallBig start offset : " + offset);
      long smallBig = nextBig(Byte.toUnsignedInt(data[offset++]));
      System.out.println("DEBUG: nextSmallBig offset : " + offset + " smallbig : " + smallBig);
      return smallBig;
  }
